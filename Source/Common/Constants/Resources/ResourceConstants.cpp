...
const char* RES_TILE_SNOW = "SnowTile";
const char* RES_TILE_TREE = "TreeTile";
const char* RES_TILE_ROCK = "RockTile";
const char* RES_TILE_ICE = "IceTile";
const char* RES_TILE_WATER = "WaterTile";
const char* RES_TILE_ENDPOINT = "EndPointTile";
const char* RES_TILE_STARTPOINT = "StartPointTile";
const char* RES_TILE_TOWER = "Tower";