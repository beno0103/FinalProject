...
extern const char* SAVE_LOAD_MENU_SCREEN_NAME;
extern const char* HIGHSCORES_MENU_SCREEN_NAME;
extern const char* SETTINGS_MENU_SCREEN_NAME;
extern const char* GAMEOVER_MENU_SCREEN_NAME;
extern const char* WIN_MENU_SCREEN_NAME;
